...
_Question_ : Lors de l’utilisation de terraform apply -replace, que se passe-t-il pour les ressources qui dépendent de la ressource à recréer ?
...
3. Ne pas utiliser de remote backend
4. **Utiliser HCP Terraform**<br>
   <span style="color:green">HCP Terraform connecte le VCS à son propre mécanisme de CD, il n’est plus nécessaire de créer un pipeline de CD.</span>
